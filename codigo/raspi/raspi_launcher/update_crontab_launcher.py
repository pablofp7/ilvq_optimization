...
crontab_line = f"@reboot sleep 120 && cd /home/pablo/ilvq_optimization/codigo/raspi && echo 'Starting super_launcher at $(date)' > super_launcher.log 2>&1 && python3 super_launcher.py {launcher} >> super_launcher.log 2>&1"
