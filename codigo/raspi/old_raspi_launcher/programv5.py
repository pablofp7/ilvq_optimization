...
import pandas as pd
from old_node_class.raspi_nodev5 import RaspiNodev5
import time
import threading
import numpy as np
import socket
...
def main(df: pd.DataFrame):
    ...
    nodo = RaspiNodev5(id, dataset=df_nodos[id], modelo_proto=XuILVQ(max_pset_size=limit, target_size=target_range), nodos=n_nodos, s=s, T=t, media_llegadas=media_llegadas)
