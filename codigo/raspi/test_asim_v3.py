...
def main(df: pd.DataFrame): 
    ...
    for id in range(n_nodos):
        nodo = Nodev3(id, dataset=df_nodos[id], modelo_proto=XuILVQ(), nodos=n_nodos, s=s, T=t, media_llegadas=t_entre_llegadas if id != 4 else t_entre_llegadas * 5)
        nodos.append(nodo)    
...
if __name__ == "__main__":
    try:
        ...
        T = T / 1000
        tasa_llegadas = 4
        t_entre_llegadas = 1/ tasa_llegadas
        ...
        directorio_resultados = "resultados_asim_v3"
